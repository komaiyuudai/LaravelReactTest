...
// サービスselectフォーム
var SelectService = React.createClass({displayName: "SelectService",
    // stateの初期化
    getInitialState: function(){
    ...
    render: function() {
        ...
        return(
            React.createElement("div", {className: "SelectService"}, 
...
// メンバーselectフォーム
var SelectMember = React.createClass({displayName: "SelectMember",
    // stateの初期化
    getInitialState: function(){
        return {
            memberValue: 'test3'
    ...
    render: function() {
        ...
        return(
            React.createElement("div", {className: "SelectMember"}, 
                React.createElement("input", {type: "text", value: value, onChange: this.handleChange})
            )
        );
    }
...
// formまとめ
var MemberUseServiceForm = React.createClass({displayName: "MemberUseServiceForm",
    render: function() {
        return(
            React.createElement("div", {className: "MemberUseServiceForm"}, 
                React.createElement(SelectMember, null), 
                React.createElement(SelectService, null), 
...
var MemberUseService = require('./form/member_use_service_form.jsx');

ReactDOM.render(
    React.createElement(MemberUseService, null),
    document.getElementById('content')
);

},{"./form/member_use_service_form.jsx":159,"react":158,"react-dom":2}]},{},[160]);
